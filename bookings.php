...
<body>
    <div class= "container my-5">
        ...
        <a class="btn btn-primary" href="/mywebsite/createbookings.php" role="button">New Booking</a>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-primary btn-sm' href='/mywebsite/editbookings.php?reservationid=$row[reservationid]'>Edit</a>
                            <a class='btn btn-danger btn-sm' href='/mywebsite/deletebookings.php?reservationid=$row[reservationid]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
