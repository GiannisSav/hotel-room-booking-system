...
<body>
    <div class= "container my-5">
        ...
        <a class="btn btn-primary" href="/mywebsite/create.php" role="button">New Customer</a>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-primary btn-sm' href='/mywebsite/edit.php?id=$row[id]'>Edit</a>
                            <a class='btn btn-danger btn-sm' href='/mywebsite/delete.php?id=$row[id]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
