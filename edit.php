...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    if (!$row) {
        header ("loction: /mywebsite/index.php");
        exit;
    }
    ...
    do {
        if ( empty($id) || empty($fname) || empty($sname) || empty($email) || empty($address) || empty($phone) ) {
            $errorMessage = "Please fill in all the fields";
            break;
        }

        $sql = "UPDATE customers " . 
                "SET fname = '$fname', sname = '$sname', email = '$email', address = '$address', phone = '$phone' " . 
                "WHERE id = $id";
