...
<body>
    <div class= "container my-5">
        ...
        <a class="btn btn-primary" href="/mywebsite/createhotels.php" role="button">New Hotel</a>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>$row[fax]</td>
                        <td>
                            <a class='btn btn-primary btn-sm' href='/mywebsite/edithotels.php?hotelid=$row[hotelid]'>Edit</a>
                            <a class='btn btn-danger btn-sm' href='/mywebsite/deletehotels.php?hotelid=$row[hotelid]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
