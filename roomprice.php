...
<body>
    <div class= "container my-5">
        ...
        <h2>List of Room Prices</h2>
        <a class="btn btn-primary" href="/mywebsite/createroomprice.php" role="button">New Room Price</a>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    echo "
                    <tr>
                        <td>$row[roompriceid]</td>
                        <td>$row[roomid]</td>
                        <td>$row[roomprice]</td>
                        <td>
                            <a class='btn btn-primary btn-sm' href='/mywebsite/editroomprice.php?roompriceid=$row[roompriceid]'>Edit</a>
                            <a class='btn btn-danger btn-sm' href='/mywebsite/deleteroomprice.php?roompriceid=$row[roompriceid]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
