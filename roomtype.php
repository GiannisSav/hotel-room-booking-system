...
<body>
    <div class= "container my-5">
        ...
        <h2>List of Room Types</h2>
        <a class="btn btn-primary" href="/mywebsite/createroomtype.php" role="button">New Room Type</a>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>$row[roomtype]</td>
                        <td>
                            <a class='btn btn-primary btn-sm' href='/mywebsite/editroomtype.php?roomtypeid=$row[roomtypeid]'>Edit</a>
                            <a class='btn btn-danger btn-sm' href='/mywebsite/deleteroomtype.php?roomtypeid=$row[roomtypeid]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
